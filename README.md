...
2. Name two big differences between ```display: block;``` and ```display: inline;```.
    ...
    Inline elements are contained on 1 line. Block elements break to new lines. 
...
5. Explain why git is valuable to a team of developers.
    ...
    git is a version control system which allows teams of developers to work on separate 
    branches of the same project. This is valuable because they can revert back to any previous
    version when mistakes are made. Developers can control when they update the main production version and can wait until it's perfect.
